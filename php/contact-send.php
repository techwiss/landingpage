...
//***
		...
		if (!empty($data["date"])){
			$pre_messagebody_info.="<strong>Appointment Date</strong>" . ": " . $data['date'] . "<br />";
		}
        ...
        if (mail($ourMail, $subject, $pre_messagebody_info .= "<strong>Message</strong>" . ": " . $data['message'] .$after_message, $headers)) {
            $result["info"] = "success";
        } else {
